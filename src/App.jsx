import { RatingTableRow } from "./components/CharacterRatings";
    ...
    <>
      <section id="character-ratings">
        ...
        <table>
          ...
          {topFiveArr.map((item, itemIndex) => {
            const adjIndex = itemIndex + 1;
            const isEven = adjIndex % 2 === 0;
            return (
              <RatingTableRow item={item} isEven={isEven} key={item.name} />
            );
          })}
        </table>
      </section>
